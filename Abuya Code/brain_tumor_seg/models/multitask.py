...
def run_model(
    ...
    kwargs = {}
    if tumor_mask is not None and "tumor_mask" in params:
        kwargs["tumor_mask"] = tumor_mask
    if radiomics is not None and "radiomics" in params:
        kwargs["radiomics"] = radiomics
    if kwargs:
